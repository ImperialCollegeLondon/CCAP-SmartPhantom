...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
    ...
    if( togglePhantom ) // If phantom walls are enabled
    {
        ...
        //waterLogical = new G4LogicalVolume(waterBox,waterMaterial,"waterboxLogical");
        //new G4PVPlacement(0,G4ThreeVector(),waterLogical,"waterPhysical",phantomLogical,false,0,checkOverlaps);
